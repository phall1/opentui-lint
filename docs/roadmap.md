...
palette. There is usually nothing to match a hex against, and nearest-color
...
Investigated and **not built**. The premise, that an unfocused `<input>` is
...
[`rules/require-focus-rejected.md`](rules/require-focus-rejected.md).
